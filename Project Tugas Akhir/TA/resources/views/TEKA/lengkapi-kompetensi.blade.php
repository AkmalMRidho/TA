...
<div class="container mt-4">
    ...
    <form action="{{ route('lengkapi-kompetensi-teka.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
	<div id="dynamic_form">
        ...
        <div class="form-group mb-4">
            ...
            <select name="jabatan" class="form-control" required>
                ...
                <option value="Teknisi Laboratorium Informatika">Teknisi Laboratorium Informatika</option>
